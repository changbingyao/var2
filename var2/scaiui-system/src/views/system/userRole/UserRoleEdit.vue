<template>
    <el-form :model="data" :rules="rules" ref="editForm" label-width="120px">
        <el-row>
            <sFormItem2 :label="$t('userRole.userRoleId')" prop="userRoleId">
                <el-input v-model="data.userRoleId" :disabled="operator=='view'"></el-input>
            </sFormItem2>
            <sFormItem2 :label="$t('userRole.userCode')" prop="userCode">
                <el-input v-model="data.userCode" :disabled="operator=='view'"></el-input>
            </sFormItem2>
            <sFormItem2 :label="$t('userRole.roleCode')" prop="roleCode">
                <el-input v-model="data.roleCode" :disabled="operator=='view'"></el-input>
            </sFormItem2>
            <sFormItem2 :label="$t('userRole.crtUserCode')" prop="crtUserCode">
                <el-input v-model="data.crtUserCode" :disabled="operator=='view'"></el-input>
            </sFormItem2>
            <sFormItem2 :label="$t('userRole.crtOrgCode')" prop="crtOrgCode">
                <el-input v-model="data.crtOrgCode" :disabled="operator=='view'"></el-input>
            </sFormItem2>
            <sFormItem2 :label="$t('userRole.crtDate')" prop="crtDate">
                <el-input v-model="data.crtDate" :disabled="operator=='view'"></el-input>
            </sFormItem2>
            <sFormItem2 :label="$t('userRole.updUserCode')" prop="updUserCode">
                <el-input v-model="data.updUserCode" :disabled="operator=='view'"></el-input>
            </sFormItem2>
            <sFormItem2 :label="$t('userRole.updOrgCode')" prop="updOrgCode">
                <el-input v-model="data.updOrgCode" :disabled="operator=='view'"></el-input>
            </sFormItem2>
            <sFormItem2 :label="$t('userRole.updDate')" prop="updDate">
...
<script>
    export default {
        ...
        methods: {
             ...
             */
            userAdd() {
                this.$service.post('/system/userRoles', this.data)
                        .then(r => {
             ...
             */
            userEdit() {
                this.$service.put('/system/userRoles', this.data)
                        .then(r => {
                    if (r.data.code === this.$successCode) {
                    this.$emit('closeDialog', false)
                    this.$emit('loadData')
