      ...
      <el-row type="flex" justify="start" style="margin: 0 !important;">
        <el-col :span="1">
          <div class="nav-item nav-icon"
               @click="toggleShrink"
               :style="[{transform: isShrink ? 'rotate(90deg)' : 'rotate(0deg)'}, {lineHeight: isShrink ? '5.5' : '4'}]">
            <img src="../../assets/img/menu-light.png">
          </div>
        </el-col>
        <el-col :span="20">
        ...
        <el-col :span="2" style="text-align: right;">
          <div class="nav-item">
            <el-dropdown @command="handleLang" :style="[{color: headerStyle.color}, {fontSize: '12px'}, {verticalAlign: 'top'}, {cursor: 'pointer'}]" trigger="click">
              ...
              <el-dropdown-menu slot="dropdown" style="margin-top: 0; top: 25px !important;font-size: 12px !important;">
        ...
        <el-col :span="2" style="text-align: right;padding-right: 5px;">
          <el-dropdown @command="handleRightCommand" style="color: #606266;font-size: 12px;" trigger="click">
            ...
            <el-dropdown-menu slot="dropdown" style="margin-top: 0; top: 25px !important;">
              <el-dropdown-item command="modify">{{$t('modifyPwd')}}</el-dropdown-item>
