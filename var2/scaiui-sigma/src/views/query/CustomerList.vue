  ...
  <div>
    ...
    <el-row type="flex" justify="left">
      <el-form label-position="right" :inline="true" style="width: 100%;">
        <sFormItem3 :label="$t('customQuery.custom')">
          <el-input style="width: 88%;" v-model="custom" :placeholder="$t('placeholder.default',[$t('customQuery.custom')])" clearable></el-input>
        </sFormItem3>
    ...
    <el-row>
      <el-table style="width: 100%" border :data="data.rows" tooltip-effect="light">
        ...
        <el-table-column prop="regSystemDesc" :label="$t('customQuery.custom')" show-overflow-tooltip width="120"></el-table-column>
        ...
        <el-table-column prop="averageTotalTime" :label="$t('batchQuery.avgTotalTime')" show-overflow-tooltip width="150"></el-table-column>
    ...
    methods: {
      ...
      loadData(index) {
        ...
        this.params = Object.assign({
          limit: this.limit,
          offset: this.offset,
          regSystemDesc: this.custom,
          vendorName: this.provider,
          interfaceDesc: this.productName
        });
        this.$service.get('/fee/feeInfoDefines/selectListThree', {params: this.params})
          .then(r => {
